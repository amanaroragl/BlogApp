...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void openAddPost() {
    Navigator.push(context,
        new MaterialPageRoute(builder: (context) => new AddPostList()));
  }
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            ...
            settings: RouteSettings(
              arguments: bloc.fetchItemPost(bloc.fetchPosts()[index]),
            )));
  }
}
